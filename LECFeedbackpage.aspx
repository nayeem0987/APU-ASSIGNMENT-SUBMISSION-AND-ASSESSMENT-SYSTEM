<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LECFeedbackpage.aspx.cs" Inherits="_Default" %>
            ...
            <table class="auto-style1">
                ...
                <tr>
                    <td class="auto-style3">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:Image ID="Image1" runat="server" Height="57px" ImageUrl="~/IMAGES/APU LOGO.jpeg" Width="199px" />
                    </td>
                </tr>
                <tr>
                    <td class="auto-style13">&nbsp;
                        ...
                        <asp:Panel ID="Panel1" runat="server" Font-Bold="True" Font-Size="Larger" ForeColor="Gray">
                            Submit your Feedback about the system:<br />
                        </asp:Panel>
                        <table class="auto-style17">
                            ...
                            <tr>
                                ...
                                <td class="auto-style36" style="color: #FF0000">
                            ...
                            <tr>
                                ...
                                <td class="auto-style26" style="color: #FF0000">
                                    ...
                                    *<asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="TextBox3" ErrorMessage="Please enter correct phone number!!!" ForeColor="Black" ValidationExpression="^(\+?6?01)[0-46-9]-*[0-9]{7,8}$"></asp:RegularExpressionValidator>
                                </td>
                            </tr>
                            <tr>
                                <td class="auto-style29">&nbsp;</td>
                                <td class="auto-style32">
                                    <asp:Label ID="Label7" runat="server" Font-Bold="True" Text="Feedback:"></asp:Label>
                                </td>
                                <td class="auto-style22" style="color: #FF0000">
                                    <asp:TextBox ID="TextBox4" runat="server" Height="94px" onkeypress="return this.value.length<=250"   TextMode="MultiLine" Width="325px"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td class="auto-style22">
                                    <asp:Button ID="Button7" runat="server" Text="Submit" CssClass="auto-style33" Font-Bold="True" ForeColor="White" OnClick="Button7_Click" style="height: 26px" />
                                    &nbsp; <asp:Button ID="Button8" runat="server" Text="Reset" CssClass="auto-style33" Font-Bold="True" ForeColor="White" OnClick="Button8_Click" Height="27px" />
                                    <br />
                                    <br />
                                    <asp:Label ID="Label13" runat="server" Text="Label" Visible="False"></asp:Label>
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionStringAPUASSIGNMENTSYS %>" SelectCommand="SELECT * FROM [Lec_Feedback]"></asp:SqlDataSource>
