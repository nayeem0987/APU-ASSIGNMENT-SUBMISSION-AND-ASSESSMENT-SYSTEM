...
public partial class Assignmentsubmit : System.Web.UI.Page
{
    ...
    protected void Button10_Click(object sender, EventArgs e)
    {
...

        {
            ...
            {
                string query = "insert into All_Assignment values (@Assignment_Name, @Content_Type, @Data)";
                using (SqlCommand cmd = new SqlCommand(query))
                {
                    cmd.Connection = con;
                    cmd.Parameters.AddWithValue("@Assignment_Name", filename);
                    ...
                    lblmessage.Text = "Congrats! Your assignment is uploaded in encrypted mode!";
                }
            }
