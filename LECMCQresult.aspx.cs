...
public partial class MCQresult : System.Web.UI.Page
{
    ...
    protected void Button7_Click(object sender, EventArgs e)
    {
        SqlConnection Zcon = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionStringAPUASSIGNMENTSYS"].ConnectionString);
        Zcon.Open();
        string Zinst = "INSERT INTO MCQ_Result VALUES('" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox3.Text + "','" + TextBox4.Text + "','" + TextBox5.Text + "','" + TextBox6.Text + "','" + TextBox7.Text + "','" + TextBox8.Text + "','" + DropDownList1.Text + "','" + TextBox9.Text + "')";
        ...
        try
        {
            ...
            msg.Subject = "Hello, " + TextBox4.Text + "...We hope you are doing good!";
            msg.Body = "You'r MCQ test number: "+ TextBox8.Text +" result for the module: " + TextBox3.Text + " is published kindly login to the assignment submission and assesment to view your result....thanks";
