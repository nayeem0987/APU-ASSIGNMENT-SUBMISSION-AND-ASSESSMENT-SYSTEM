<%@ Page Language="C#" AutoEventWireup="true" CodeFile="STGroupassignment.aspx.cs" Inherits="Groupassignment" %>
            ...
            <table class="auto-style1">
                ...
                <tr>
                    <td class="auto-style3">&nbsp;
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:Image ID="Image1" runat="server" Height="57px" ImageUrl="~/IMAGES/APU LOGO.jpeg" Width="196px" />
                    </td>
                </tr>
                <tr>
                    <td class="auto-style13">&nbsp;<asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            ...
                            <asp:Label ID="Label24" runat="server" Font-Bold="True" Font-Size="Larger" ForeColor="#666666" Text="Submit Group Assignment:"></asp:Label>
                        ...
                        <table class="auto-style17">
                            <tr>
                                ...
                                <td class="auto-style37">
                                    <asp:Label ID="Label3" runat="server" Font-Bold="True" Text="Students Name:"></asp:Label>
                                </td>
                                <td class="auto-style21" style="color: #FF0000">
                                    Note: Add names with semicolon(;)<br />
                                    <asp:TextBox ID="TextBox1" onkeyup="this.value=this.value.toUpperCase()" runat="server" Height="71px" Width="252px"></asp:TextBox>
                                    *<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBox1" ErrorMessage="Please enter your Group members name!" ForeColor="Black"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                                <td class="auto-style48"></td>
                                <td class="auto-style49">
                                    <asp:Label ID="Label4" runat="server" Font-Bold="True" Text="Students TP Number:"></asp:Label>
                                </td>
                                <td class="auto-style50" style="color: #FF0000">
                                    Note: Add TP numbers with semicolon(;)<br />
                                    <asp:TextBox ID="TextBox2" runat="server" Height="68px" Width="254px"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td class="auto-style39">
                                    <asp:Label ID="Label6" runat="server" Font-Bold="True" Text="Email-Address: (The student who is submitting)"></asp:Label>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="auto-style43">
                                    <asp:Label ID="Label15" runat="server" Font-Bold="True" Text="Assignment Document:"></asp:Label>
                                </td>
                                <td class="auto-style44" style="color: #FF0000">
                                    ...
                                    <br class="auto-style51" />
                                    <asp:Button ID="Button9" runat="server" CssClass="auto-style40" Font-Bold="True" OnClientClick="myFunction(); return Button9_Click" Onclick= "Button9_Click" Text="Encrypt the Assignment Document" Width="246px"  />
                                    <br class="auto-style51" />
                                    ...
                                    <br class="auto-style51" />
                                    <asp:Label ID="Label8" runat="server" Text="3. Then upload the encrypted version in the database." style="display:none"></asp:Label>
                                    <asp:Button ID="Button10" runat="server" CssClass="auto-style40" Font-Bold="True" Text="Upload Group Assignment" Width="249px" OnClick="Button10_Click" style="display:none" />
                                    ...
                                    <br class="auto-style51" />
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionStringAPUASSIGNMENTSYS %>" SelectCommand="SELECT * FROM [Group_Assignment]"></asp:SqlDataSource>
                            ...
                            <tr>
                                ...
                                <td class="auto-style22">
                                    ...
                                    <br />
                                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionStringAPUASSIGNMENTSYS %>" SelectCommand="SELECT * FROM [Group_Submit]"></asp:SqlDataSource>
                                    <br />
                                    <br />
