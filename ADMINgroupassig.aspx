<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ADMINgroupassig.aspx.cs" Inherits="ADMINgroupassig" %>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Panel ID="Panel1" runat="server" Height="660px">
                            <asp:Label ID="Label24" runat="server" Font-Bold="True" Font-Size="Larger" ForeColor="#666666" Text="Check submitted Group Assignments:"></asp:Label>
                            <br />
                            <br />
                            <table class="auto-style52">
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style22">
                                        <asp:Button ID="Button7" runat="server" CssClass="auto-style33" Font-Bold="True" ForeColor="White" Height="45px" OnClick="Button7_Click" Text="View Group Assignment" Width="249px" />
                                        &nbsp;<br />
                            ...
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataKeyNames="Id" Width="1103px">
                                <Columns>
