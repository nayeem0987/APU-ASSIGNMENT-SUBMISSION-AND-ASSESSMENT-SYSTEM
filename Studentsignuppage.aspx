<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Studentsignuppage.aspx.cs" Inherits="Singuppage" %>
            ...
            <table class="auto-style1">
                ...
                <tr>
                    <td class="auto-style3">&nbsp;
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:Image ID="Image1" runat="server" Height="57px" ImageUrl="~/IMAGES/APU LOGO.jpeg" Width="192px" />
                    </td>
                </tr>
                <tr>
                        ...
                        <table class="auto-style17">
                            ...
                            <tr>
                                ...
                                <td class="auto-style22" style="color: #FF0000">
                                    ...
                                    *<asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ErrorMessage="Please enter correct Phone Number!!" ControlToValidate="TextBox9" ForeColor="Black" ValidationExpression="^(\+?6?01)[0-46-9]-*[0-9]{7,8}$"></asp:RegularExpressionValidator>
                                </td>
                            </tr>
                            <tr>
                                <td class="auto-style34">&nbsp;</td>
                                <td class="auto-style37">
                                    <asp:Label ID="Label7" runat="server" Font-Bold="True" Text="Select Your Course:"></asp:Label>
                                </td>
                                <td class="auto-style21">
                                    <asp:DropDownList ID="DropDownList1" runat="server">
                                        <asp:ListItem>Please Select.</asp:ListItem>
                                        <asp:ListItem>Computing and IT</asp:ListItem>
                            ...
                            <tr>
                                ...
                                <td class="auto-style22">
                                    <asp:TextBox ID="TextBox5" runat="server" ReadOnly="True">STUDENT</asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="auto-style36">&nbsp;</td>
                                ...
                                <td class="auto-style22" style="color: #FF0000">
                                    ...
                                    *<asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="TextBox6" ErrorMessage="Either your password is more than Eight caracter or It is not strong..!!!" ForeColor="Black" ValidationExpression="(?!^[0-9]*$)(?!^[a-zA-Z]*$)^([a-zA-Z0-9]{7,8})$"></asp:RegularExpressionValidator>
                                    <br />
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="auto-style22" style="color: #FF0000">
                                    ...
                                    *<asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="TextBox6" ControlToValidate="TextBox7" ErrorMessage="Password doesnot match!!" ForeColor="Black"></asp:CompareValidator>
                                </td>
                            </tr>
                            <tr>
                                <td class="auto-style36"></td>
                                ...
                                <td class="auto-style22" style="color: #FF0000">
                                    <asp:TextBox ID="TextBox10" onkeyup="this.value=this.value.toUpperCase()"  runat="server"></asp:TextBox>
                                    *<asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Please enter your friend name for further verification!!!" Font-Bold="False" ForeColor="Black" ControlToValidate="TextBox10"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                                <td class="auto-style36">&nbsp;</td>
                            ...
                            <tr>
                                ...
                                <td class="auto-style22">
                                    ...
                                    &nbsp;<asp:Button ID="Button8" runat="server" Text="Reset" CssClass="auto-style33" Font-Bold="True" ForeColor="White" OnClick="Button8_Click" />
                                    <br />
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionStringAPUASSIGNMENTSYS %>" SelectCommand="SELECT * FROM [Student_SIGNUP_Details]"></asp:SqlDataSource>
                                    <br />
