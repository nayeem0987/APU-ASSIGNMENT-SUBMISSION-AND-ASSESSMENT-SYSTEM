<%@ Page Language="C#" AutoEventWireup="true" CodeFile="STSendmessage.aspx.cs" Inherits="Sendmessage" %>
                ...
                <tr>
                    <td class="auto-style13">&nbsp;
                        ...
                        <asp:Panel ID="Panel1" runat="server" Font-Bold="True" Font-Size="Larger" ForeColor="Gray">
                            Send Message to Lecturer about assignemt:<br />
                        </asp:Panel>
                        <table class="auto-style17">
                            ...
                            <tr>
                                <td class="auto-style29">&nbsp;</td>
                                <td class="auto-style32">
                                    <asp:Label ID="Label29" runat="server" Font-Bold="True" Text="Assignmet Title:"></asp:Label>
                                </td>
                                <td class="auto-style22" style="color: #FF0000">
                                    <asp:TextBox ID="TextBox9" onkeyup="this.value=this.value.toUpperCase()" runat="server"></asp:TextBox>
                                    *<asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="TextBox9" ErrorMessage="Please enter Assignment Title!!!" ForeColor="Black"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                                <td class="auto-style29">&nbsp;</td>
