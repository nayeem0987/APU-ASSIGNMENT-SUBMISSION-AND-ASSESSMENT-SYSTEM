<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Adminloginpage.aspx.cs" Inherits="Studentloginpage" %>
            ...
            <table class="auto-style1">
                <tr>
                    <td class="auto-style2">
                        ...
                        <asp:Button ID="Button6" runat="server" CssClass="auto-style16" Height="27px" Text="Feedback" Width="80px" />
                    </td>
                </tr>
                <tr>
                        ...
                        <table class="auto-style17">
                            ...
                            <tr>
                                ...
                                <td class="auto-style22">
                                    <asp:Button ID="Button7" runat="server" Text="Login" CssClass="auto-style33" Font-Bold="True" ForeColor="White" OnClick="Button7_Click" Height="27px" />
