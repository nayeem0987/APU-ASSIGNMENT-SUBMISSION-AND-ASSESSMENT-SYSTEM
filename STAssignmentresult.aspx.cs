...
public partial class Assignmentresult : System.Web.UI.Page
{
    ...
    public DataSet Bind()
    {
        SqlConnection Zcon = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionStringAPUASSIGNMENTSYS"].ConnectionString);
        Zcon.Open();
        SqlCommand Zcmd = new SqlCommand("SELECT * FROM  In_Assig_Results WHERE St_TP= '"+TextBox2.Text+"' and Module_Code= '"+TextBox5.Text+"'", Zcon);
