<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin_acc_key_REQ.aspx.cs" Inherits="Admin_acc_key_REQ" %>
            ...
            <table class="auto-style1">
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Panel ID="Panel1" runat="server" Height="765px">
                            <asp:Label ID="Label24" runat="server" Font-Bold="True" Font-Size="Larger" ForeColor="#666666" Text="View ALL access key Request from Lecturer:"></asp:Label>
                            <br />
                            <br />
                            &nbsp;
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" AutoGenerateDeleteButton="True" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataKeyNames="Id" DataSourceID="SqlDataSource3" Width="967px">
                                <Columns>
                            ...
                            &nbsp;<asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionStringAPUASSIGNMENTSYS %>" SelectCommand="SELECT * FROM [Access_key]"></asp:SqlDataSource>
                            <br />
                            <asp:Label ID="Label28" runat="server" Font-Bold="True" Font-Size="Large" ForeColor="#666666" Text="Verify Lecturer Email:"></asp:Label>
                            <br />
                            &nbsp;<br />
                            <table class="auto-style14">
                                <tr>
                                    ...
                                    <td class="auto-style23">
                                        <asp:Label ID="Label29" runat="server" Text="Enter Email:"></asp:Label>
                                    </td>
                                    <td class="auto-style21">
                                        <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
                                        <span class="auto-style16">*</span><asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="Email is not correct!!" ControlToValidate="TextBox1" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="auto-style20">&nbsp;</td>
                                    ...
                                    <td class="auto-style21">
                                        <asp:Button ID="Button1" runat="server" CssClass="auto-style17" Font-Bold="True" ForeColor="White" Text="Verify" Width="114px" OnClick="Button1_Click" />
                                        <br />
                                        <br />
                            ...
                            <br />
                            <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataKeyNames="Id"  Width="951px">
                                <Columns>
                            ...
                            <br />
                            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionStringAPUASSIGNMENTSYS %>" SelectCommand="SELECT * FROM [New_Lec]"></asp:SqlDataSource>
                            <br />
                            <br />
                            <br />
                            <br />
