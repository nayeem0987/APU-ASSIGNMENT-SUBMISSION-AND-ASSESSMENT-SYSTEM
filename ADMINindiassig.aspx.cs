...
public partial class ADMINindiassig : System.Web.UI.Page
{
    ...
    public DataSet Bind()
    {
        ...
        Zcon.Open();
        SqlCommand Zcmd = new SqlCommand("SELECT * FROM  All_Assignment INNER JOIN Assignment_Datas ON All_Assignment.Id = Assignment_Datas.Id WHERE Reference='" + TextBox1.Text + "'", Zcon);
