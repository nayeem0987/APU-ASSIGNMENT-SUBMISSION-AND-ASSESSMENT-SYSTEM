...
public partial class MCQresult : System.Web.UI.Page
{
    ...
    public DataSet Bind()
    {
        SqlConnection Zcon = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionStringAPUASSIGNMENTSYS"].ConnectionString);
        Zcon.Open();
        SqlCommand Zcmd = new SqlCommand("SELECT * FROM  MCQ_Result WHERE Student_TP= '" + TextBox2.Text + "' and Module_Code= '" + TextBox5.Text + "' and Test_Number = '"+TextBox6.Text+"'", Zcon);
    ...
    protected void Button7_Click(object sender, EventArgs e)
    {
        ...
        if (!object.Equals(ds, null))
        {
            ...
            else
            {
                ...
                Label28.Text = "Sorry your result is not updated yet in the system..!";
