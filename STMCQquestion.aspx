<%@ Page Language="C#" AutoEventWireup="true" CodeFile="STMCQquestion.aspx.cs" Inherits="MCQquestion" %>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Panel ID="Panel1" runat="server">
                            <asp:Label ID="Label24" runat="server" Font-Bold="True" Font-Size="Larger" ForeColor="#666666" Text="Download MCQ Question:"></asp:Label>
                            <br />
                            <table class="auto-style17">
                                ...
                                <tr>
                                    <td class="auto-style36">&nbsp;</td>
                                    <td class="auto-style39">
                                        <asp:Label ID="Label32" runat="server" Font-Bold="True" Text="MCQ TEST NUMBER:"></asp:Label>
                                    </td>
                                    <td class="auto-style22" style="color: #FF0000">
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style22">
                                        <asp:Button ID="Button7" runat="server" CssClass="auto-style33" Font-Bold="True" ForeColor="White" Height="45px" OnClick="Button7_Click" Text="Fetch MCQ Test Question" Width="249px" />
                                        &nbsp;<br />
                            ...
                            <br />
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataKeyNames="Id" Width="929px">
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="MCQ_Test_No" HeaderText="MCQ_Test_No" SortExpression="MCQ_Test_No" />
                                    ...
                                    <asp:BoundField DataField="Name" HeaderText="MCQ_Ques" SortExpression="Name" />
                            ...
                            <br />
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionStringAPUASSIGNMENTSYS %>" SelectCommand="SELECT MCQ_Q.Id, MCQ_Q.Name, MCQ_Q.Content_Type, MCQ_Q.Data, MCQ_Q_D.Intake, MCQ_Q_D.Lec_Phone, MCQ_Q_D.Module_Code, MCQ_Q_D.MCQ_Test_No, MCQ_Q_D.Lec_Name, MCQ_Q_D.Lec_Email FROM MCQ_Q INNER JOIN MCQ_Q_D ON MCQ_Q.Id = MCQ_Q_D.Id"></asp:SqlDataSource>
                            <br />
                            <br />
                            <br />
                            <br />
