...
public partial class Submittedgroup : System.Web.UI.Page
{
    ...
    public DataSet Bind()
    {
        SqlConnection Zcon = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionStringAPUASSIGNMENTSYS"].ConnectionString);
        Zcon.Open();
        SqlCommand Zcmd = new SqlCommand("SELECT * FROM  Group_Assignment INNER JOIN Group_Submit ON Group_Assignment.Id = Group_Submit.Id WHERE Module_Code='" + TextBox4.Text + "' and St_Intake='"+TextBox3.Text+"'", Zcon);
    ...
    protected void Button9_Click(object sender, EventArgs e)
    {
        SqlConnection zcon = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionStringAPUASSIGNMENTSYS"].ConnectionString);
        zcon.Open();
        string query = "INSERT INTO Late_B VALUES('" + TextBox6.Text + "', '" + TextBox7.Text + "','" + TextBox8.Text + "','" + TextBox9.Text + "','"+TextBox10.Text+"')";
        ...
        cmd.ExecuteNonQuery();
        {
...

            {
                ...
                msg.Body = "This is a notification from your lecturer: " + TextBox8.Text + " and his email is " + TextBox9.Text + " , because your group have submitted assignment which reference number is: "+TextBox6.Text+" , late for the module: " + TextBox10.Text + " and now you will need to submit an EC with vaild reason to the admin... so the lecturer will be able to mark your assignment...Thanks.";
                ...
                try
                {
                    ...
                    try
                    {
                        ...
                        msg1.Body = "This is a notification from the lecturer: " + TextBox8.Text + " and his email is " + TextBox9.Text + " , because a student's group reference number of assignment is: " + TextBox6.Text + " ,have submitted assignment late for the module: " + TextBox10.Text + " and now you they will submit an EC with vaild reason to the admin... so the lecturer will be able to mark their  assignment basis on the EC result...Thanks.";
