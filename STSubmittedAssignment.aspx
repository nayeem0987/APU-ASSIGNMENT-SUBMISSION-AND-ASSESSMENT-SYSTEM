<%@ Page Language="C#" AutoEventWireup="true" CodeFile="STSubmittedAssignment.aspx.cs" Inherits="SubmittedAssignment" %>
            ...
            <table class="auto-style1">
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label31" runat="server" Font-Bold="True" Font-Size="Large" ForeColor="#666666" Text="Check submitted Individual Assignments:&nbsp;&nbsp;"></asp:Label>
                        <br />
                        <table class="auto-style53">
                            ...
                            <tr>
                                ...
                                <td class="auto-style22">
                                    <asp:Button ID="Button7" runat="server" Text="View all submitted Assignment" CssClass="auto-style33" Font-Bold="True" ForeColor="White" OnClick="Button7_Click" Height="45px" Width="249px" />
                                    &nbsp;<br />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" >
                            <Columns>
                                ...
                                <asp:BoundField DataField="Assignment_Name" HeaderText="Assignment_Document" SortExpression="Assignment_Name" />
