...
public partial class MCQques : System.Web.UI.Page
{
    ...
    protected void Button10_Click(object sender, EventArgs e)
    {
...

        {
            ...
            {
                string query = "insert into MCQ_Q values (@Name, @Content_Type, @Data)";
                using (SqlCommand cmd = new SqlCommand(query))
                {
                    ...
                    lblmessage.Text = "MCQ TEST question is uploaded in database!";
                }
            }
    ...
    protected void Button7_Click(object sender, EventArgs e)
    {
        SqlConnection Zcon = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionStringAPUASSIGNMENTSYS"].ConnectionString);
        Zcon.Open();
        string Zinst = "INSERT INTO MCQ_Q_D VALUES('" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox3.Text + "','" + TextBox4.Text + "','" + TextBox5.Text + "','" + TextBox6.Text + "')";
        SqlCommand Zcmd = new SqlCommand(Zinst, Zcon);
        Zcmd.ExecuteNonQuery();

        Label33.Visible = true;
        Label33.Text = "The MCQ TEST Question is seccessfully publised...Thanks for using the system!";
