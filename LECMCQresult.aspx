<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LECMCQresult.aspx.cs" Inherits="MCQresult" %>
                ...
                <tr>
                    <td class="auto-style13">&nbsp;<asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            ...
                            <asp:Label ID="Label24" runat="server" Font-Bold="True" Font-Size="Larger" ForeColor="#666666" Text="Publish MCQ Result:"></asp:Label>
                        ...
                        <table class="auto-style17">
                            ...
                            <tr>
                                ...
                                <td class="auto-style22" style="color: #FF0000">
                                    ...
                                    *<asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="TextBox6" ErrorMessage="Please enter student Name!!" ForeColor="Black"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                                <td class="auto-style36">&nbsp;</td>
                                ...
                                <td class="auto-style22" style="color: #FF0000">
                                    ...
                                    *<asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="TextBox7" ErrorMessage="Please enter student TP!!!" ForeColor="Black"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                                <td class="auto-style36">&nbsp;</td>
                                <td class="auto-style39">
                                    <asp:Label ID="Label37" runat="server" Font-Bold="True" Text="MCQ Test number:"></asp:Label>
                                </td>
                                <td class="auto-style22" style="color: #FF0000">
                                    <asp:TextBox ID="TextBox8" runat="server"></asp:TextBox>
                                    *<asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="TextBox8" ErrorMessage="Please enter Test number!!!" ForeColor="Black"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                                <td class="auto-style36">&nbsp;</td>
                                <td class="auto-style39">
                                    <asp:Label ID="Label35" runat="server" Font-Bold="True" Text="Result:"></asp:Label>
                                </td>
                                <td class="auto-style22" style="color: #FF0000">
                                    Choose Grade:<br />
                            ...
                            <tr>
                                ...
                                <td class="auto-style22" style="color: #FF0000">
                                    ...
                                    *<asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server" ControlToValidate="TextBox9" ErrorMessage="Please enter correct student email!!" ForeColor="Black" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
                                </td>
                            </tr>
                            <tr>
                                <td class="auto-style36">&nbsp;</td>
...
&nbsp;
                                    <br />
                                    Note: (Please enter correct Credantials from the MCQ Answer of the student.)<br />
                                    <br />
                                    <asp:Label ID="Label33" runat="server" ForeColor="Red" Text="Label" Visible="False"></asp:Label>
                                    <br />
                                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionStringAPUASSIGNMENTSYS %>" SelectCommand="SELECT * FROM [MCQ_Result]"></asp:SqlDataSource>
                                    <br />
                                    <br />
