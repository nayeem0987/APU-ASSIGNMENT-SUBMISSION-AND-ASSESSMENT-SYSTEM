<%@ Page Language="C#" AutoEventWireup="true" CodeFile="STEditprofile.aspx.cs" Inherits="Editprofile" %>
                        ...
                        <table class="auto-style17">
                            ...
                            <tr>
                                ...
                                <td class="auto-style21" style="color: #FF0000">
                                    <asp:TextBox ID="TextBox2" onkeyup="this.value=this.value.toUpperCase()" runat="server" ReadOnly="True"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td class="auto-style26" style="color: #FF0000">
                                    ...
                                    *<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="TextBox8" ErrorMessage="Please enter your Intake code!" ForeColor="Black"></asp:RequiredFieldValidator>
                                    <br />
                                    <br />
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="auto-style22" style="color: #FF0000">
                                    ...
                                    *<asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="Enter correct Email!!!" ForeColor="Black" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" ControlToValidate="TextBox9"></asp:RegularExpressionValidator>
                                    <br />
                                    <br />
                            ...
                            <tr>
                                ...
                                <td class="auto-style22" style="color: #FF0000">
                                    <br />
                                    Note: You can edit phone number.<br />
                                    <asp:TextBox ID="TextBox5" runat="server" ReadOnly="True"></asp:TextBox>
                                    <br />
                                    <br />
                                    <asp:TextBox ID="TextBox10" runat="server"></asp:TextBox>
                                    *<asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ErrorMessage="Please enter correct Phone Number!!" ControlToValidate="TextBox10" ForeColor="Black" ValidationExpression="^(\+?6?01)[0-46-9]-*[0-9]{7,8}$"></asp:RegularExpressionValidator>
                                    <br />
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="auto-style14">
                                    <br />
                                    <asp:Label ID="Label7" runat="server" Font-Bold="True" Text="Your Course:"></asp:Label>
                                </td>
                                <td class="auto-style14">
                                    <br />
                            ...
                            <tr>
                                ...
                                <td class="auto-style22" style="color: #FF0000">
                                    <br />
                                    Note: You can change your best friend name.<br />
                                    <asp:TextBox ID="TextBox7" onkeyup="this.value=this.value.toUpperCase()"  runat="server" ReadOnly="True"></asp:TextBox>
                                    <br />
                                    <br />
                                    <asp:TextBox ID="TextBox11" onkeyup="this.value=this.value.toUpperCase()" runat="server"></asp:TextBox>
