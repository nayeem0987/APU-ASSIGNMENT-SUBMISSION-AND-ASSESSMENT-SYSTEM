<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin_lec_name_email.aspx.cs" Inherits="Admin_lec_name_email" %>
                        ...
                        <table class="auto-style17">
                            ...
                            <tr>
                                ...
                                <td class="auto-style22" style="color: #FF0000">
                                    ...
                                    *<asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="TextBox6" ErrorMessage="Enter Correct Email!!" ForeColor="Black" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
                                </td>
                            </tr>
                            <tr>
                                <td class="auto-style29">&nbsp;</td>
                                <td class="auto-style32">
                                    <asp:Label ID="Label7" runat="server" Font-Bold="True" Text="Descirption:"></asp:Label>
                                </td>
                                <td class="auto-style22" style="color: #FF0000">
                            ...
                            <tr>
                                ...
                                <td class="auto-style22">
                                    <asp:Button ID="Button7" runat="server" Text="Update" CssClass="auto-style33" Font-Bold="True" ForeColor="White" OnClick="Button7_Click" Height="28px" Width="202px" />
                                    &nbsp; 
                                    <br />
