<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin_Acc-pass.aspx.cs" Inherits="Admin_Acc_pass" %>
                    ...
                    <td class="auto-style13">&nbsp;
                        ...
                        <table class="auto-style17">
                            ...
                            <tr>
                                <td class="auto-style29">&nbsp;</td>
                                <td class="auto-style32">
                                    <asp:Label ID="Label7" runat="server" Font-Bold="True" Text="Password Message:"></asp:Label>
                                    <br />
                                    <br />
                                </td>
                                <td class="auto-style22" style="color: #FF0000">
                                    <asp:TextBox ID="TextBox7" runat="server" Height="119px" onkeypress="return this.value.length<=250"   TextMode="MultiLine" Width="329px" ReadOnly="True">THE ACCESS KEY PASSWORD IS : AAA12</asp:TextBox>
                                    *<br />
                                </td>
                            </tr>
                            <tr>
