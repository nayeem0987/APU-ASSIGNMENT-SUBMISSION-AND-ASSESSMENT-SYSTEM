<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ADMINALLEC.aspx.cs" Inherits="ADMINALLEC" %>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Panel ID="Panel1" runat="server">
                            <asp:Label ID="Label24" runat="server" Font-Bold="True" Font-Size="Larger" ForeColor="#666666" Text="View all EC Regarding Assignments:"></asp:Label>
                            <br />
                            <br />
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" AutoGenerateDeleteButton="True" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataKeyNames="Id" DataSourceID="SqlDataSource1">
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Name" HeaderText="EC_DOCUMENT" SortExpression="Name" />
                                    <asp:TemplateField HeaderText="Download and Check">
                                        <ItemTemplate>
                            ...
                            <br />
                            <br />
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionStringAPUASSIGNMENTSYS %>" DeleteCommand="Delete from EC INNER JOIN EC_Details ON EC.Id = EC_Details.Id" SelectCommand="SELECT EC.Id, EC.Name, EC.Conter_Type, EC.Data, EC_Details.St_Name, EC_Details.St_TP, EC_Details.Intake, EC_Details.St_Email, EC_Details.St_Phone, EC_Details.Module_Code, EC_Details.Lecturer_Name, EC_Details.Lecturer_Email, EC_Details.Assignment_Title, EC_Details.EC_Reason, EC_Details.Reference_Number, EC_Details.Ec_Submission_time FROM EC INNER JOIN EC_Details ON EC.Id = EC_Details.Id">
                                <DeleteParameters>
