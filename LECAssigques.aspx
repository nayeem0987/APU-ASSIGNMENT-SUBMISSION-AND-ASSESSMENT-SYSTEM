<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LECAssigques.aspx.cs" Inherits="Assigques" %>
                ...
                <tr>
                    <td class="auto-style13">&nbsp;<asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            ...
                            <asp:Label ID="Label24" runat="server" Font-Bold="True" Font-Size="Larger" ForeColor="#666666" Text="Upload Assignment Question:"></asp:Label>
                        ...
                        <table class="auto-style17">
                            ...
                            <tr>
                                ...
                                <td class="auto-style22" style="color: #FF0000">
                                    ...
                                    *<asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="TextBox6" ErrorMessage="Please enter assignment title!!" ForeColor="Black"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                                <td class="auto-style42"></td>
                                <td class="auto-style43">
                                    <asp:Label ID="Label15" runat="server" Font-Bold="True" Text="Assignment Ques:"></asp:Label>
                                </td>
                                <td class="auto-style44" style="color: #FF0000">
                                    ...
                                    <br />
                                    <asp:Button ID="Button10" runat="server" CssClass="auto-style40" Font-Bold="True" Text="Upload Assignment Question" Width="249px" OnClick="Button10_Click" />
                                    ...
                                    <br />
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionStringAPUASSIGNMENTSYS %>" SelectCommand="SELECT * FROM [Assig_Q]"></asp:SqlDataSource>
                            ...
                            <tr>
                                ...
                                <td class="auto-style22">
                                    <br />
                                    <asp:Button ID="Button7" runat="server" Text="Publish Assignment Question." CssClass="auto-style33" Font-Bold="True" ForeColor="White" OnClick="Button7_Click" Height="36px" />
                                    &nbsp;<br />
                                    <br />
                                    <asp:Label ID="Label33" runat="server" ForeColor="Red" Text="Label" Visible="False"></asp:Label>
                                    <br />
                                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionStringAPUASSIGNMENTSYS %>" SelectCommand="SELECT * FROM [Assig_Q_D]"></asp:SqlDataSource>
                                    <br />
                                    <br />
