<%@ Page Language="C#" AutoEventWireup="true" CodeFile="STMCQanswer.aspx.cs" Inherits="MCQanswer" %>
                ...
                <tr>
                    <td class="auto-style13">&nbsp;<asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            ...
                            <asp:Label ID="Label24" runat="server" Font-Bold="True" Font-Size="Larger" ForeColor="#666666" Text="Submit MCQ Answer:"></asp:Label>
                        ...
                        <table class="auto-style17">
                            ...
                            <tr>
                                ...
                                <td class="auto-style22" style="color: #FF0000">
                                    ...
                                    *<asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="TextBox9" ErrorMessage="Please enter the MCQ number!!" ForeColor="Black"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                                <td class="auto-style42"></td>
                                <td class="auto-style43">
                                    <asp:Label ID="Label15" runat="server" Font-Bold="True" Text="MCQ Answer:"></asp:Label>
                                </td>
                                <td class="auto-style44" style="color: #FF0000">
                                    ...
                                    <asp:Button ID="Button10" runat="server" CssClass="auto-style40" Font-Bold="True" Text="Upload MCQ answer" Width="249px" OnClick="Button10_Click" />
                                    ...
                                    <br />
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionStringAPUASSIGNMENTSYS %>" SelectCommand="SELECT * FROM [MCQ_Answer]"></asp:SqlDataSource>
                            ...
                            <tr>
                                ...
                                <td class="auto-style22">
                                    <asp:Button ID="Button7" runat="server" Text="Submit MCQ Answer" CssClass="auto-style33" Font-Bold="True" ForeColor="White" OnClick="Button7_Click" Height="36px" />
                                    &nbsp;<br />
                                    <br />
                                    <asp:Label ID="Label33" runat="server" ForeColor="Red" Text="Label" Visible="False"></asp:Label>
                                    <br />
                                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionStringAPUASSIGNMENTSYS %>" SelectCommand="SELECT * FROM [Submitted_Assignment_Details]"></asp:SqlDataSource>
                                    <br />
                                    <br />
